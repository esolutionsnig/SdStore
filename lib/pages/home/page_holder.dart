  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        buttonBackgroundColor: cprimary,
        height: 50,
        items: <Widget>[
          Icon(Icons.category, size: 20, color: cwhite),
          Icon(Icons.add_shopping_cart, size: 20, color: cwhite),
          Icon(Icons.home, size: 20, color: cwhite),
          Icon(Icons.favorite, size: 20, color: cwhite),
          Icon(Icons.contact_phone, size: 20, color: cwhite),
        ],
