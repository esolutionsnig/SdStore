...
class LoaderDot extends StatefulWidget {
  ...
  LoaderDot({
    this.dotOneColor = cprimary,
    this.dotTwoColor = cgold,
    this.dotThreeColor = cteal,
  ...
  @override
  _LoaderDotState createState() => _LoaderDotState();
}

class _LoaderDotState extends State<LoaderDot>
